...
namespace MVC5Course.Models.Attributes
{
    public class PersonalIDFormat_Taiwan : DataTypeAttribute
    {
        public PersonalIDFormat_Taiwan() : base(DataType.Text)
        {
        ...
        public override bool IsValid(object value)
        {
            ...
            return string.IsNullOrEmpty(id) || isIdentificationId(id);
        }
